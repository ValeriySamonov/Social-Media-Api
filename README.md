...
Для хранения рефреш токена используется HashMap для простоты реализации. В реальном проекте предпочтительнее использовать постоянное хранилище, например Redis.
