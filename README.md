...
## Документация API
Файл social_media_api.yaml в корневой папке проекта содержит описание API. Вы можете открыть этот файл в редакторе Swagger по адресу [https://editor.swagger.io] для детального изучения доступных запросов.
